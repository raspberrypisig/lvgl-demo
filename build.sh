...
cd lv_micropython/
sed -ir 's/LV_FONT_MONTSERRAT_48    0/LV_FONT_MONTSERRAT_48    1/' lib/lv_bindings/lv_conf.h
sed -ir 's/LV_FONT_MONTSERRAT_32    0/LV_FONT_MONTSERRAT_32    1/' lib/lv_bindings/lv_conf.h
make -C mpy-cross
make -C ports/unix
cd /home/pi/Desktop
